  ...
  this.tasks = {
    ...
    'LIST': {
      '1': 'fruits apples fuji', 
      '2': 'foods fruits apples fuji grains vegetables squash',
      '3': 'foods fruits grains vegetables squash' 
    },
   ...
   'MOVE vegetables foods': 'MOVE vegetables foods',
    'DELETE fruits/apples': 'DELETE fruits/apples Cannot delete fruits/apples - fruits does not exit',
...
console.log(Failure.tasks.LIST)